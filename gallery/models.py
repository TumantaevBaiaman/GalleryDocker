...
class GalleryImg(models.Model):
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='gallery_img')
    update = models.DateTimeField(auto_now=True)
    timestamp = models.DateTimeField(auto_now_add=True)
...
class GalleryVideo(models.Model):
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='gallery_video')
    update = models.DateTimeField(auto_now=True)
    timestamp = models.DateTimeField(auto_now_add=True)
